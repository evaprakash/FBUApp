...
public interface YelpService {
    ...
    Call<ResponseBody> filteredSearch(@Query("term") String term, @Query("location") String location, @Query("categories") String category, @Query("sort_by") String sortBy, @Query("limit") int limit);
}